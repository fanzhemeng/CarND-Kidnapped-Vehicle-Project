...
/**
 * Computes each measurement's Multivariate-Gaussian probability density.
 * @param (x_obs,y_obs) x and y coordinates of observations in map
 * @param (mu_x,mu_y) x and y coordinates of nearest landmark
 * @param (sig_x, sig_y) standard deviation for x and y
 * @output each measurement's Multivariate-Gaussian probability.
 */
